...
/*!
\brief This the  member function Base::virtualBaseMemberFunction1(int) const of the Base class

Detailed documentation to the \c{Base::virtualBaseMemberFunction1(int) const}  function with the argument \a xyz.
...
*/
void Base::virtualBaseMemberFunction1(int xyz) const
{
}
...
/*!
\brief This the  member function Base::baseMemberFunction1() const of the Base class

Detailed documentation to the \c{Base::baseMemberFunction1() const}  function with the argument.
...
/*!
\brief This the  member function Base::baseStaticMemberFunction1() const of the Base class

Detailed documentation to the \c{Base::baseStaticMemberFunction1() const}  function with the argument.
...
*/
void Base::baseStaticMemberFunction1()
{
}
